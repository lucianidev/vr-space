...
var createHistory = (source) => {
  ...
  return {
    ...
    navigate(to, { state, replace = false } = {}) {
      ...
      location2 = getLocation(source);
      listeners.forEach(
        (listener) => listener({ location: location2, action: "PUSH" })
      );
...
function instance3($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$props2) => {
    if ("basepath" in $$props2)
      $$invalidate(6, basepath = $$props2.basepath);
    if ("url" in $$props2)
      $$invalidate(7, url = $$props2.url);
    if ("history" in $$props2)
      $$invalidate(8, history = $$props2.history);
    if ("$$scope" in $$props2)
...
var Router = class extends SvelteComponentDev {
  constructor(options) {
    super(options);
    init(this, options, instance3, create_fragment3, safe_not_equal, { basepath: 6, url: 7, history: 8 });
    dispatch_dev("SvelteRegisterComponent", {
      component: this,
      tagName: "Router",
      options,
