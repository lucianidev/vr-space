...
{#if $userState.isLogged}
  ...
  <nav class="flex justify-end items-center bg-gray-50 dark:bg-gray-800">
    ...
    <div class="p-4">
      ...
      <button data-drawer-target="default-sidebar" on:click={() => interacttNav()} data-drawer-toggle="default-sidebar" aria-controls="default-sidebar" type="button" class="inline-flex items-center p-2 mt-2 ml-3 text-sm text-gray-500 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
